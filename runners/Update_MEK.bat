@echo off
set ESSENTIALS_VERSION=2.0.0
if exist mek_python\pythonw.exe (
    start mek_python\pythonw.exe mek_python\mek\MEK_Installer.pyw --install-dir mek_python\mek --disable-uninstall-btn --essentials-version %ESSENTIALS_VERSION% --meke-dir %cd%
) else (
